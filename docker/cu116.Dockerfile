...
# Start instructions: xhost local:root && docker run -it -d --rm -e SDL_VIDEODRIVER=x11 -e DISPLAY=$DISPLAY --env='DISPLAY' --gpus all --ipc host --privileged --network host -p 8080:8081 -v /tmp/.X11-unix:/tmp/.X11-unix:rw -v /home/$USER/:/home/$USER/ -v /weights:/weights openpcdet:cuda11 xfce4-terminal --title=openPCDet
