...
def get_official_eval_result(gt_annos, dt_annos, current_classes, PR_detail_dict=None):
    ...
    overlap_0_5 = np.array([[0.7, 0.7, 0.7, 0.7,
                             0.7, 0.7], [0.7, 0.7, 0.7, 0.7, 0.70, 0.7],
...
#     # Stack the overlap arrays as done originally
...
#     # Filter for the Pedestrian class only (class id = 1)
#     if name_to_class["Pedestrian"] in current_classes:
#         min_overlaps = min_overlaps[:, :, [name_to_class["Pedestrian"]]]
...
#     ret_dict = {}
#     for j, curcls in enumerate(current_classes):
#         # Loop through the three min_overlaps (0.7, 0.5, and 0.25) for the Pedestrian class
#         for i in range(min_overlaps.shape[0]):
#             result += print_str(
#                 (f"{class_to_name[curcls]} "
#                  "AP@{:.2f}, {:.2f}, {:.2f}:".format(*min_overlaps[i, :, j])))
